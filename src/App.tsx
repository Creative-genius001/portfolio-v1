  ...
  return (
    ...
    <div className="relative bg-black w-full">
        <div className=" h-[100vh] absolute top-0 right-0">
          <img src="https://source.unsplash.com/Im7lZjxeLhg" alt=""  className="w-full h-full object-cover"/>
        </div>
       <Navbar />
        <SocialLinks />
        <UpBtn />
      ...
      <section id="home" className="hero-section relative z-100 w-full h-[calc(100vh-70px)] lg:px-[200px] sm:px-[25px] flex lg:justify-center sm:items-start  lg:items-center">
        <div className="hero-section-content lg:pt-0 sm:pt-[6rem] ">
          ...
          <p id="name-desc2" className="text-slate-100 lg:w-[70%] sm:w-full mt-4 lg:text-base sm:text-sm ">I am a Web Developer based in Nigeria and I specialize in building (and occasionally designing) exceptional digital experiences.</p>
          <button id="resume-button" className="code relative btn-main w-[230px] px-[20px] py-[15px] bg-tech-purple mt-12 ">
            <a href="https://docs.google.com/document/d/1z8HKrAoCnWiz__dg3CH78TM3OBxXHGHy/edit?usp=drive_link&ouid=112585428787449489995&rtpof=true&sd=true" target="_blank">Check out my Resume</a>
          </button>
        </div>
      ...
      <section id="about" className="about-section overflow-hidden w-full lg:px-[200px] sm:px-[25px] py-[4rem]  flex lg:flex-row sm:flex-col flex-1 justify-between items-center ">
        <div className=" lg:w-1/2 sm:w-full">
          ...
          <p className="lg:text-base sm:text-sm ">As a Web Developer, I possess an impressive arsenal of skills in HTML, CSS, JavaScript, React, Tailwind, and SCSS. I excel in designing and maintaining responsive websites that offer a smooth user experience. My expertise lies in crafting dynamic, engaging interfaces through writing clean and optimized code and utilizing cutting-edge development tools and techniques. I am also a team player who thrives in collaborating with cross-functional teams to produce outstanding web applications.</p>
      ...
      <section id="projects" className="project-section  w-full lg:px-[200px] sm:px-[25px] py-[4rem] flex flex-1 justify-between items-center">
          <div className="project-container w-full h-auto">
            <h1 className="lg:text-[2rem] sm:text-[1.5rem] font-bold lg:mb-4 sm:mb-2 ">Things I have Built</h1>
      ...
      <footer className="w-full pt-[10rem] pb-8 flex flex-col justify-center items-center">
        <div className='footer-icons flex justify-evenly mb-4 w-[20%]'>
            ...
            <a href='https://twitter.com/ovieDgenius'><FiTwitter className='icon text-slate-300 lg:text-[1.3rem] sm:text-[1.1rem] hover:text-tech-blue transition-all duration-300 ' /></a>
